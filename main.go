...
func main() {
	...
	// Ejecutar servidor web en una goroutine para que no bloquee el menú consola
	go func() {
		http.HandleFunc("/", handlers.Home)
		http.HandleFunc("/libros", handlers.MostrarLibros)
		http.HandleFunc("/prestar", handlers.PrestarLibroHandler)
		http.HandleFunc("/devolver", handlers.DevolverLibroHandler)
		http.HandleFunc("/nuevo", handlers.FormularioNuevoLibro)
		http.HandleFunc("/guardar", handlers.GuardarLibro)
		http.HandleFunc("/eliminar", handlers.EliminarLibroHandler)
